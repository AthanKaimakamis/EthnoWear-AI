...
public class KnowledgeChunk extends UpdatableEntity {
    ...
    @Column(name = "GenerationInputHash", length = 64, columnDefinition = "char(64)")
    private String generationInputHash;

    @Column(name = "ChunkingStrategy", length = 100)
    private String chunkingStrategy;

    @Column(name = "ChunkingVersion", length = 50)
