...
public class Document extends UpdatableEntity {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "DefaultSourceReferenceId")
    private SourceReference defaultSourceReference;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "ThumbnailMediaAssetId")
    private MediaAsset thumbnailMediaAsset;
