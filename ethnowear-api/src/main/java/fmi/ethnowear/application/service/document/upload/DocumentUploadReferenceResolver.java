...
public class DocumentUploadReferenceResolver {
    ...
    public void requireDocumentSource(Document document, SourceReference sourceReference) {
        ...
        requireSource(document.getSource(), sourceReference);
    }

    public void requireSource(Source source, SourceReference sourceReference) {
        if(sourceReference == null)
            return;
        ...
        if(source == null
         || !source.getId().equals(referenceSource.getId()))
