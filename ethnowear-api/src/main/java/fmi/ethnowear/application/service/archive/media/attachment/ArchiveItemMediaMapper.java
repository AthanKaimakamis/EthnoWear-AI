...
public class ArchiveItemMediaMapper {
    ...
    public void apply(
            @NonNull ArchiveItemMedia itemMedia,
            @NonNull ArchiveItemMediaWriteDto input,
    ...
    public ArchiveItemMediaDetails toDetails(@NonNull ArchiveItemMedia itemMedia) {
        return new ArchiveItemMediaDetails(
                itemMedia.getId(), itemMedia.getArchiveItem().getId(),
                itemMedia.getMediaAsset().getId(), itemMedia.getRole(),
                itemMedia.getCaptionBg(), itemMedia.getCaptionEn(),
                itemMedia.getCreatedAt(), itemMedia.getUpdatedAt()
        );
    }
}
