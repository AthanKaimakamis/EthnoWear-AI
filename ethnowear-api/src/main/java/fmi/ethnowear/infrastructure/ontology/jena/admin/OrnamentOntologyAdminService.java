...
import fmi.ethnowear.application.exception.InvalidOrnamentException;
import fmi.ethnowear.application.exception.OrnamentAlreadyExistsException;
import fmi.ethnowear.application.exception.OrnamentInUseException;
...
@Service
public class OrnamentOntologyAdminService implements OrnamentOntologyAdminPort {
