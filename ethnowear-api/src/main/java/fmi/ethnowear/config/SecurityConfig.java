    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                HttpMethod.POST,
                                "/api/admin/document-pages/*/transcription/reset-from-current-ocr"
                        ).hasRole("ADMINISTRATOR")
                        .requestMatchers(
                                HttpMethod.GET,
                                "/api/admin/**"
                        ...
                        .requestMatchers(
                                ...
                                "/api/admin/document-pages/*/figures/*/approve",
                                "/api/admin/document-pages/*/figures/*/reject",
                        ...
                        .requestMatchers(
                                HttpMethod.POST,
                                "/api/admin/document-pages/*/text-suggestions/*/apply",
                                "/api/admin/document-pages/*/text-suggestions/*/issues/*/apply"
                        ).hasAnyRole(
                                "ADMINISTRATOR",
                                "REVIEWER",
                                "EDITOR"
                        )
                        .requestMatchers("/api/admin/retrieval/**")
                        .hasAnyRole(
                                "ADMINISTRATOR",
                                "REVIEWER",
                                "EDITOR"
