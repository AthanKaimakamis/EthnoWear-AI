...
from ethnowear_document_worker.temp.workspace import JobWorkspace, cleanup_stale_workspaces
...
def test_workspace_creates_private_job_directory_and_removes_it(
    ...
    with JobWorkspace.create(tmp_path, job_id=11, attempt=2) as workspace:
        ...
        assert workspace.input_image == job_directory / "input-image"
        assert workspace.preprocessed_image == (
            job_directory / "preprocessed.png"
        )
