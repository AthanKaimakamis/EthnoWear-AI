...
def inspect_pdf(
    ...
    try:
        ...
        for index in range(page_count):
            ...
            # Match MuPDF's integer pixel rounding used by get_pixmap(dpi=...).
            pixel_width = round(rectangle.width * render_dpi / 72)
            pixel_height = round(rectangle.height * render_dpi / 72)
