...
from ethnowear_worker.jobs.heartbeat import HeartbeatSupervisor
from ethnowear_worker.jobs.page_extraction import (
    build_manifest,
    build_rendition_metadata,
    validate_manifest_response,
)
from ethnowear_worker.pdf.inspector import inspect_pdf
from ethnowear_worker.pdf.renderer import render_page
from ethnowear_worker.temp.workspace import JobWorkspace
                ...
                async with asyncio.timeout(
                    ...
                    with JobWorkspace.create(
                        ...
                        for manifest_page in manifest.pages:
                            ...
                            if not manifest_page.rendition_required:
                                continue
