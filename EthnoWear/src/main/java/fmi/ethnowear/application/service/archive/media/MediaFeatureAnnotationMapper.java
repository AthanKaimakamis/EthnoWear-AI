...
public class MediaFeatureAnnotationMapper {
    ...
    public void apply(@NonNull MediaFeatureAnnotation annotation, @NonNull MediaFeatureAnnotationWriteDto input, ArchiveItemMedia itemMedia, ArchiveItemFeature itemFeature) {
    ...
    public MediaFeatureAnnotationDetails toDetails(@NonNull MediaFeatureAnnotation annotation) {
        return new MediaFeatureAnnotationDetails(
                ...
                annotation.getArchiveItemFeature().getId(),
